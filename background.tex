...
\begin{figure}[H]
	\begin{center}
		\begin{tikzpicture}[scale=0.9]
			...
			\begin{scope}[shift={(0, 2)}]
				...
				\begin{scope}[shift={(-3,0)}, scale=0.7]
					...
					\node[anchor=east, align=center] at (-0.5,2) {\footnotesize Boundary\\[-0.2em] \footnotesize layer\\[-0.2em] \footnotesize thickness,\\[-0.2em] {\footnotesize$\delta$}};
					
					
					% External flow
					\draw[->, thick, blue] (0,5) -- (2.5,5);
					\node[blue, anchor=west, align=center] at (2.7,4.8) {\footnotesize Free flow\\[-0.2em] \footnotesize velocity,\\[-0.2em] \footnotesize$U$};
		...
		\end{tikzpicture}
	\end{center}
	\caption{Depiction of boundary layer and the velocity gradient formed. The red dotted line depicts the outline of the bluff body. Inspired by \textcite{erau_boundarylayer}.} 
...
\begin{figure}[H]
	\begin{center}
		\begin{tikzpicture}[scale=0.2, >=Stealth]
			...
			\draw[->, thick] (0,39) -- (0,36) node[midway, right] {Flow with velocity $U$};
