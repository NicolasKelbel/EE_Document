...
To adhere to the scope of this essay the simulation setup is adapted from a case study provided in the Udemy course OpenFOAM for Absolute Beginners by \textcite{jayaraj2024openfoam}. The tutorial case 3vortexShedding discussed in lecture eight serves as a structural template, modifying it to align with the specific requirements of this investigation.
