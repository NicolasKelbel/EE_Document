...
When a flow moves past a bluff body in a two-dimensional plane, a boundary layer develops, with increasing thickness $\delta$ from the \textit{stagnation point} \textemdash\ the point on the leading edge of the bluff body at which the local fluid velocity is zero (with respect to the bluff body) \textemdash\ to the back of the bluff body \parencites{fitzpatrick2016_reynolds}{learneng2022_boundarylayer}. 
...
As the number of streamwise faces of the bluff body increases from 2 to 12, the vortex shedding frequency in laminar flow will decrease. This trend is attributed to a decrease in the Strouhal number as the number of streamwise faces increase \textemdash\ as confirmed by \textcite{goncalves1999strouhal} \textemdash\ which is directly proportional to the vortex shedding frequency (see \Cref{eq:strouhalNumber}). 
