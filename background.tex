...
\begin{table}[H]
	...
	\makebox[\linewidth][c]{%
		\begin{tabularx}{1.2\textwidth}{|p{2.8cm}|p{2.4cm}|X|X|X|}
			...
			\hline
			mesh.msh & - & Fluid domain of tutorial case & Fluid domain with dimensions given in \Cref{sec:ansysWorkbench} & The fluid domain has been adjusted to conform with the computational limits discussed in \Cref{sec:ansysWorkbench} \\
			\hline
			&  &  &  &  \\
			\hline
			&  &  &  &  \\
