...
\begin{table}[H]
	...
	\begin{tabularx}{\textwidth}{|X|X|}
		...
		\begin{itemize}[leftmargin=1.5em, itemsep=2pt, topsep=0pt, label=--]
			\item Ansys Workbench \parencite{noauthor_ansys_nodate}
...
\begin{table}[H]
	...
	\begin{tabularx}{\textwidth}{|X|X|}
		...
		\hline
	\end{tabularx}
	\caption*{\textbf{Table 3 (continued):} A list of the equipment required for both the theoretical and practical investigation.}
